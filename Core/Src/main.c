...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, LD1_Pin|LD3_Pin|SIOD_Pin|SIOC_Pin
  ...
  /*Configure GPIO pins : LD1_Pin LD3_Pin SIOD_Pin SIOC_Pin
                           LD2_Pin */
  GPIO_InitStruct.Pin = LD1_Pin|LD3_Pin|SIOD_Pin|SIOC_Pin
                          |LD2_Pin;
